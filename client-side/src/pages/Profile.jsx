      ...
      {userType === "employee" ? (
        ...
        <div className="w-full mt-4 p-4 sm:p-8 bg-gray-50">
          ...
          <div className="flex items-center justify-between gap-4 mb-8">
            <h2 className="text-3xl font-bold md:text-2xl">Company Profile</h2>

            <div className="flex items-center gap-4">
              <button
                type="submit"
                className="px-5 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition flex items-center justify-center"
              >
                Save Changes
              </button>

              <button
                className="px-5 py-2 rounded bg-white text-black border hover:bg-blue-700 hover:text-white transition flex items-center gap-2 justify-center"
                onClick={() => setEditMode((prev) => !prev)}
              >
                <Pencil size={16} />
                {editMode ? "Cancel" : "Edit Profile"}
